...
function! core_config#begin()
    ...
    let l:vim_plug_path = $VIM . '/vimfiles/autoload/plug.vim'
    let l:nvim_plug_path = $VIM . '/.local/share/nvim/site/autoload/plug.vim'
    ...
    if !exists('g:my_plug_home')
        if g:spacevim_nvim
            ...
            let g:my_plug_home = $VIM . '/.local/shared/nvim/plugged'
        else
